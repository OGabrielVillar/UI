...
namespace Hazel::Time::Literals 
{
	...
	_NODISCARD constexpr _CHRONO duration<double, std::ratio<3600>> operator"" _hours(long double _Val) noexcept /* strengthened */ {
	...
	_NODISCARD constexpr _CHRONO duration<double, std::ratio<60>>(operator"" _minutes)(long double _Val) noexcept /* strengthened */ {
	...
	_NODISCARD constexpr _CHRONO duration<double, std::milli> operator"" _milliseconds(long double _Val) noexcept /* strengthened */ {
	...
	_NODISCARD constexpr _CHRONO duration<double, std::micro> operator"" _microseconds(long double _Val) noexcept /* strengthened */ {
	...
	_NODISCARD constexpr _CHRONO duration<double, std::nano> operator"" _nanoseconds(long double _Val) noexcept /* strengthened */ {
